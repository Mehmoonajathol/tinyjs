...
const faqs = [
  {
    ...
    answer: "Yes. Connect any domain after upgrading your plan.",
  },
  {
    question: "Do I need technical knowledge?",
    answer: "No. We provide easy DNS setup instructions.",
  },
  {
    question: "Can I remove my domain later?",
    answer:
      "Yes. You can disconnect or replace your custom domain anytime.",
  },
];
  ...
  return (
    <div className="bg-[#f5f8fc] text-[#222]">
      ...
      <section className="bg-[#071b32] text-center text-white py-20 px-5">
        ...
        <a
          href="/signup"
          className="bg-[#19b6ff] px-9 py-4 rounded-lg font-semibold"
        >
          Create Free Account
        </a>
