...
const blogs: Blog[] = [
  {
    image:
      "https://tinyurl.com/blog/wp-content/uploads/2025/03/Hero_What-Is-Social-Media-Monitoring_-Examples-and-Top-Tools-2048x876.webp",
  ...
  {
    image:
      "https://tinyurl.com/blog/wp-content/uploads/2025/03/Hero_What-Is-Performance-Marketing_-Getting-Started-2048x878.webp",
    category: "Analytics & Performance Insights",
  ...
  {
    image:
      "https://tinyurl.com/blog/wp-content/uploads/2025/03/Hero_What-Is-Link-Management_-Top-Three-Use-Cases-and-Five-Best-Tools-2048x878.webp",
    category: "Link Management",
    title:
      "What Is Link Management? Top Three Use Cases and Five Best Tools",
    text: "Whether you’re a seasoned digital marketer, an SEO specialist, or a business owner navigating the online world.",
  },
  {
    image:
      "https://tinyurl.com/blog/wp-content/uploads/2025/03/Hero_What-Is-Audience-Segmentation_-Types-and-Tips-2048x878.webp",
    category: "Link Management",
  ...
  {
    image:
      "https://tinyurl.com/blog/wp-content/uploads/2025/03/Hero_Website-Visitor-Tracking-Top-Five-Tools-and-How-To-Get-Started-2048x878.webp",
    category: "Analytics & Performance Insights",
    title:
      "Website Visitor Tracking: Top Five Tools and How To Get Started",
    ...
    <div className="bg-[#081c36] min-h-screen text-white">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-300 text-lg leading-8 mb-8">
              URL masking is a standard web practice used by many reputable
              businesses. Let’s clarify what URL masking is, how it works,
              and when it might be a valuable tool for your website.
            </p>
      ...
      <section className="bg-[#071b32] text-center py-20 px-6">
        ...
        <p className="text-gray-300 text-lg max-w-3xl mx-auto mb-8">
          ...
          platform. Create a free account or subscribe to one of the paid
          plans.
        </p>

        <a
          href="/signup"
          className="inline-block bg-[#19b6ff] px-8 py-4 rounded-lg font-semibold"
        >
          Create Free Account
        </a>
