    ...
    <div className="bg-[#081c36] text-white min-h-screen">
      ...
      <section className="text-center px-5 py-24">
        ...
        <p className="text-xl text-gray-300">
          Compare all TinyURL plans and choose the best option for your
          business.
        </p>
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-[45%] bg-gradient-to-br from-[#0088c7] to-[#005f9c] p-10 md:p-16 flex flex-col justify-center">
            ...
            <div className="flex gap-5 flex-wrap">
              ...
              <a
                href="/signup"
                className="bg-white text-[#005f9c] px-7 py-4 rounded-lg font-semibold"
              >
                Create Free Account
              </a>
              ...
              <a
                href="/login"
                className="bg-[#071b32] text-white px-7 py-4 rounded-lg font-semibold"
              >
                Contact Sales
              </a>
